...
\begin{frame}{Device Analyser collects lots of data}{}
 \begin{itemize}
  ...
  \note{\\}
  \item 70 billion records, 2000 years, 16000 devices %TODO update these numbers
...
\begin{frame}{Root equivalent vulnerabilities are interesting}{}
 \begin{itemize}
  ...
  \item They are used in 37\% of malware %TODO check this figure
...
\end{frame}
 ...
 \pgfdeclareimage[height=0.9\textheight]{da_norm_api}{figures/da_norm_api}
 \pgfdeclareimage[height=0.9\textheight]{play_norm_api}{figures/play_norm_api}
...
\begin{frame}{Old versions of Android still in use}{Coarse grained API information}
 \pgfdeclareimage[width=0.5\textwidth]{da_norm_api_small}{figures/da_norm_api}
 \pgfdeclareimage[width=0.5\textwidth]{play_norm_api_small}{figures/play_norm_api}
 \begin{center}
  \pgfuseimage{da_norm_api_small}
