...
We describe three experiments, examining the vulnerability of Android devices in general (\S\ref{sec:exp:versionsecurity}), explore the upgrade cycle and vulnerability cycle of the ecosystem (\S\ref{sec:exp:android_ecosystem}) and quantify the updates installed on particular devices (\S\ref{sec:exp:device_updates}).

\subsection{Experiment 1: vulnerability of Android devices}\label{sec:exp:versionsecurity}
...
\subsection{Experiment 2: behaviour of the Android ecosystem}\label{sec:exp:android_ecosystem}

\subsubsection{Method} As in Experiment 1, we used the version information for each device to calculate which critical vulnerabilities each device was susceptible to on a daily basis.
...
The anomaly beginning in August 2014 is explained in \S\ref{sec:da_changes}.
...
\subsection{Experiment 3: Updates to particular devices}\label{sec:exp:device_updates}
...
\subsubsection{Method}
As in Experiment 1, we used the version information for each device to calculate which critical vulnerabilities each device was susceptible to on a daily basis.
