...
This compares badly with the number of vulnerabilities discovered per year of \avoVulnsPerYear.


\todo{That comparison is not completely fair as not all of those vulnerabilites will affect all devices, similarly we may be counting device days for which we only have one day and hence could perhaps not observe an update.}
