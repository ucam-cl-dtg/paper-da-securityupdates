...
Such apps are written by many developers from a wide range of backgrounds, which means neither operating system vendors nor users can, in general, fully trust app developers.
...
Ordinary malware can uninstalled by the user or remotely by Google through the Play Store, but such removal is unlikely to work once the security features of Android are broken.

The development of Android is distributed among many parties.
...
We present a better understanding of both the ecosystem of Android development and associated vulnerabilities more fully in \S~X.
...
For this we use handset data gathered from over 18,000 participants in the \da~\cite{} project.
...
Further analysis into the propagation of updates in Android are presented in \S~Y.
...
An alternative to regulation is better public data. 
