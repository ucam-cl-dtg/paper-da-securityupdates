...
The discovery dates of our vulnerabilities does not appear to be uniform uniform. 
...
In this paper we have analysed three critical vulnerabilities in the Android app update mechanism: APK unsigned shorts, APK unchecked name and APK duplicate file. 
