...
Our list therefore does not include any information before the start of that period.
...
investigate updates which were installed on devices that contributed data continuously over long periods of time.
