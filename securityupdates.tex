...
Figure \ref{fig:proportioninsecure} shows the proportion of Android devices in the Device Analyzer data which were running versions of Android known to root exploits at the time.
...
Chrome uses various different sandboxing methods on different platforms such as Capsicum on BSD~\cite{Watson2010} or using a SUID binary to create new namespaces and chroot on Linux~\cite{TODO}. 
