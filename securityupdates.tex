...
Android has \percMarketShare\ of the smartphone market and while the core development is controlled by Google there are about \daNumManufacturers\footnote{We computed this from the Device Analyzer~\cite{Wagner2013} data.} manufacturers which make devices which run Android.
