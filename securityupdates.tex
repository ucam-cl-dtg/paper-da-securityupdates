...
It shows the proportion of devices which are definitely vulnerable as their build was released before the vulnerability was discovered, those which might be insecure but could contain a backported fix and those which are secure as the version of Android they were running contained no known vulnerabilities on that date.
...
\begin{itemize}
 ...
 \todo{arb33: make this more concrete}
 \todo{arb33: Do we want \avo\ to provide our latest recommendations -- legal advice required}
\end{itemize}
