...
SEAndroid~\cite{Smalley2013} which is included in Android from version 4.1~\cite{https://developer.android.com/about/versions/jelly-bean.html} claimed to prevent some root vulnerabilities and to reduce the impact of others.
