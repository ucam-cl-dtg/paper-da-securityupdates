...
Red indicates updates which did not fix security vulnerabilities (because there were know known security vulnerabilities in the version of Android they were already running).
