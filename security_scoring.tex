...
We propose a method to score a device manufacturer, network operator or device model based on its historic performance at keeping devices up to date and fixing security vulnerabilities.
...
\begin{figure}
 \centering
 \includegraphics[width=\columnwidth]{figures/full_version_comp.pdf}
