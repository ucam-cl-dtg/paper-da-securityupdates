...
\todo{We don't include manufacturer specific vulnerabilities which will influence comparisons.} 
...
\todo{How does this compare with the average?}
...
\caption{Security scores for Nexus and non-Nexus devices\todo{subfig? bridge gaps?}}
