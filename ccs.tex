...
We know that organisations want to buy devices with better security and which receive updates, for example the CESG which advises UK government a advocates this~\cite{CESG2013} and we are collaborating with a FTSE 100 company to give them better information.
Before we provided this information in this paper it was not available.
We provide the answer to the question ``Who should I buy my Android phone from for best security?''
