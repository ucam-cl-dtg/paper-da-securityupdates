...
We define a security metric to rank the performance of device manufacturers and network operators, based on their provision of updates and exposure to critical vulnerabilities.
...
\section{Versions of Android running on devices}
...
\section{Vulnerability of Android dev\-ices}
