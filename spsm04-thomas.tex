...
We find that \daMeanInsecurityPercNominal\ of Android devices are exposed to at least one of \daNumVulnsUsed\ known critical vulnerabilities and assign a FUM security score of \daSecurityScoreNominal\ out of 10 while Nexus devices gets \daSecScoreBestsummaryScoreNominal\ and \daSecScoreBestmanufacturer\ \daSecScoreBestmanufacturerScoreNominal.
On average \daMeanOutstandingVulnerabilitiesNominal\ outstanding vulnerabilities are not fixed on any device and only \daUpdatednessPercNominal\ of devices run the current version of Android.
\end{abstract}
...
\section{Data}
We use two sources of data to measure the security of Android: (1) information on the distribution of Android versions over time and (2) information on the critical vulnerabilities found to affect Android.
